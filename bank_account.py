class AccountDB:
    ...
    def del_account(self, account_num):
        for account in self.account_database:
...
print(my_account_DB)
my_account_DB.del_account("0004")
print(my_account_DB)
my_account_DB.del_account("0001")
print(my_account_DB)
my_account_DB.del_account("0003")
print(my_account_DB)
